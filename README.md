...
BioAider and all the updated versions is freely available for non-commercial user at [https://github.com/ZhijianZhou01/BioAider/releases](https://github.com/ZhijianZhou01/BioAider/releases). If you privately use it for commercial purposes withou the license, you are infringing and will face the risk of being sued! Commercial users please contact us for commercial license.
After obtaining the program, users could directly run the program by clicking executable file in Windows or Linux(Ubuntu 16.04 or more) systerms without installing.
